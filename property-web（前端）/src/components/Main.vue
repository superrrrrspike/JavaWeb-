<template>
  <div>
    <div style="margin-bottom: 5px;">
        ...
        <el-button type="primary" style="margin-left:5px" @click="loadPost">搜索<i class="el-icon-search"></i></el-button>
        <el-button type="danger" style="margin-left:5px" @click="resetParam">重置<i class="el-icon-setting"></i></el-button>
        <el-button type="success" style="margin-left:5px" @click="add">新增<i class="el-icon-plus"></i></el-button>
    </div>
