<template>
  <div>
    <div style="margin-bottom: 5px;">
      <el-input v-model="name" style="width: 200px" placeholder="请输入分部名" suffix-icon="el-icon-search"
    ...
    >
      ...
      <el-table-column prop="name" label="分部名" width="120">
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        <el-form-item label="分部名" prop="name">
          <el-col :span="15">
...
export default {
  ...
  data(){
    return{
      ...
      rules: {
        name: [
          {required: true, message: '请输入分部名', trigger: 'blur'}
        ]
      }
    }
  },
